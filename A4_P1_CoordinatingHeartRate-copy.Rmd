...
#processed = read_csv("processedData.csv")
#function to perform crqa on all datasets
rqa_extractor = function(filename){ #making a function which applies the optimal parameters and then saves the rqa results
  folder = "CleanData/"
  df = read_csv(paste(folder, filename, sep=""))
  
  #add the mutate function here to add the new columns to each dataset before performing crqa
...
string = "Study2_G5_T3_Conversation.csv"


paste(string, "i.csv", sep = '_')


str_extract(string, '.*(?=\\.csv)')
